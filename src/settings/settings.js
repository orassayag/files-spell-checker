...
const settings = {
    // ===GENERAL=== //
    // Determine the mathod type of checking misspells: NAME / CONTENT.
    ...
    // ===COUNT & LIMIT=== //
    // Determine the maximum limit words to scan for misspells. After the limit exceeded the application will exit.
    ...
    // Determine the delay in milliseconds to pause before exit the application in the end.
    ...
    // For example: 'dist'.
    IGNORE_DIRECTORIES: ['dist', 'node_modules', 'dictionaries'],
